import{t as h,a as v}from"./DdhgiPT7.js";import{p as y,u as k,a as x,g as f,b as C,e as E}from"./JIWhQ8jE.js";import{p as L}from"./cgOoaaI0.js";import{b as A}from"./Cko1okt-.js";import{p as M}from"./Bn6eXXEA.js";import{o as R}from"./DxECzNoP.js";import{i as S,s as T}from"./BSN0bPPh.js";import{s as d}from"./C6tIL26B.js";/* empty css        */var j=h('<div class="shadow-host svelte-1kuj9kb"></div>');function G(u,s){y(s,!0);let g=M(s,"id",3,""),o,p=C(null);k(()=>{if(f(p)==null)return;const a=f(p).querySelectorAll(".dynamic");S.plugins.forEach(t=>{const i=t.globalVariables;a.forEach(e=>{var n;const r=(n=e.getAttribute("data-key"))==null?void 0:n.trim();r&&i[r]&&(e.textContent=i[r])})})});function w(a){const t=o.shadowRoot||o.attachShadow({mode:"open"});E(p,L(t)),t.innerHTML="";const i=document.createElement("style");i.textContent=`
      .wrapper {
        --bg: #f6f6f6;
        --card: #ffffff;
