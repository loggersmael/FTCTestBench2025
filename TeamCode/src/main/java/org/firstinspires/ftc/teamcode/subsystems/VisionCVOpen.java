...
/*
public class VisionCV extends SubsystemBase
{
    ...
    double cY = 0;
    double width = 0;
    public VisionCV(HardwareMap aHardwareMap, Telemetry telemetry)
    {
...
{
    double distance = (ColorPipeline.objectWidthInRealWorldUnits * ColorPipeline.focalLength) / width;
    return distance;
}
