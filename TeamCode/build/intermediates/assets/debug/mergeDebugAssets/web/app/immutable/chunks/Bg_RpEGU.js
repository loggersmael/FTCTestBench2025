import{t as h,a as v}from"./CVFpzJbc.js";import{p as y,u as k,a as x,g as f,b as C,e as E}from"./YTTbxKC9.js";import{p as L}from"./DVvdcNCm.js";import{b as A}from"./DGA7EyOo.js";import{p as M}from"./CCV5vNUE.js";import{o as R}from"./BuTlqoie.js";import{i as S,s as T}from"./DWCKsEeI.js";import{s as d}from"./DakgemTn.js";/* empty css        */var j=h('<div class="shadow-host svelte-1kuj9kb"></div>');function G(u,s){y(s,!0);let g=M(s,"id",3,""),o,p=C(null);k(()=>{if(f(p)==null)return;const a=f(p).querySelectorAll(".dynamic");S.plugins.forEach(t=>{const i=t.globalVariables;a.forEach(e=>{var n;const r=(n=e.getAttribute("data-key"))==null?void 0:n.trim();r&&i[r]&&(e.textContent=i[r])})})});function w(a){const t=o.shadowRoot||o.attachShadow({mode:"open"});E(p,L(t)),t.innerHTML="";const i=document.createElement("style");i.textContent=`
      .wrapper {
        --bg: #f6f6f6;
        --card: #ffffff;
